...
hip_roll_l_m = servo(hip_roll_l, ROLL_TORQUE, "hip_roll_l_m")
hip_roll_r_m = servo(hip_roll_r, ROLL_TORQUE, "hip_roll_r_m")
hip_pitch_l_m = servo(hip_pitch_l, PITCH_TORQUE, "hip_pitch_l_m")
hip_pitch_r_m = servo(hip_pitch_r, PITCH_TORQUE, "hip_pitch_r_m")
knee_l_m = servo(knee_l, KNEE_TORQUE, "knee_l_m")
knee_r_m = servo(knee_r, KNEE_TORQUE, "knee_r_m")
ankle_l_m = servo(ankle_l, ANKLE_TORQUE, "ankle_l_m")
ankle_r_m = servo(ankle_r, ANKLE_TORQUE, "ankle_r_m")
...
ankle_roll_l_m = servo(ankle_roll_l, ANKLE_TORQUE, "ankle_roll_l_m")
ankle_roll_r_m = servo(ankle_roll_r, ANKLE_TORQUE, "ankle_roll_r_m")
...
balance = assembly.policy(stand, weights="stand10.cxpolicy",
                          sha256="dc375a4255efedc00ddbb0ccacf6c899a38f1c08e71c65a0cd17ddfd7bb74947",
                          label="balance")
play = assembly.rollout(balance, frames_per_second=25, seed=7,
                        label="stand_play")
