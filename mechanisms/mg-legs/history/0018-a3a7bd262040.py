...
REWARD = [
    ...
    # B6: the capture point, and the term that makes a step pay NOW.
    assembly.reward("tanh((" + XI + ") / 40.0)",
                    weight=-0.8, label="capture"),
    ...
    # A 800 mm/s recovery cost -1.6/step at -0.002. It is a fourth of that.
    assembly.reward("abs(pv_x) + abs(pv_y) + abs(pv_z)",
                    weight=-0.0005, label="stillness"),
    assembly.reward("abs(pw_x) + abs(pw_y) + abs(pw_z)",
                    weight=-0.0005, label="spin"),
